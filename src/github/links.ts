...
export function parseGitHubReferences(text: string): GitHubReference[] {
...
export async function enrichReferences(refs: GitHubReference[]): Promise<GitHubReference[]> {
  const enriched: GitHubReference[] = [];
